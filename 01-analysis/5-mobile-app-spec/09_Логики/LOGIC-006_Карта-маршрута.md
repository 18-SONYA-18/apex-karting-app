...
| ID | Название | Приоритет |
|----|----------|-----------|
| NFR-1 | Доступность: карта — не единственный носитель информации; место сбора и название/тип конфигурации трассы дублируются текстом — [НФТ](../../2-requirements/non-functional-requirements) | Высокий |
