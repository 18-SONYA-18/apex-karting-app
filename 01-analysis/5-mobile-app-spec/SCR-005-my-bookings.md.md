...
|----|----------|-----------|
| FR-35a | Показывать клиенту список его бронирований (предстоящие и прошедшие) со статусом, параметрами слота, числом мест и вариантом экипировки — [Функциональные требования](../2-requirements/functional-requirements.md) | Must |
...
| ID | Название | Приоритет |
|----|----------|-----------|
| US-9 | Клиент видит список своих записей (предстоящих и прошедших) со статусом, параметрами слота, числом мест и вариантом экипировки — [User stories](../2-requirements/user-stories.md) | Must |
