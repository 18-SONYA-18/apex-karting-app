...
> (самостоятельная запись на заезды уличного картинг-центра, роль «Клиент»).
...
правило 2 часов отмены, фильтрация слотов, карта трассы, запрос push-разрешения, паттерн
...
- **Числа не хардкодятся:** потолки конфигураций трасс, прокатный фонд экипировки, цены, лимиты приходят из
  данных слота/конфигурации трассы.
- **Дизайн-макеты Figma зафиксированы.** Источник — файл
  [Figma «Апекс приложение»](https://www.figma.com/design/ySEt0cjmRqmhdWyDlTpDM5/Апекс-приложение?node-id=71-4857)
  ...
  (находки RR-D01…RR-D11). Числа по-прежнему не хардкодятся — берутся из данных слота/конфигурации трассы и
